...
function initRain() {
  ...
  containers.forEach(container => {
    ...
    // Spawn new icon every 1.77 seconds
    let currentCol = 0;
    setInterval(() => {
...
function renderPaseCorporativoWidget() {
  const SP_LOGO = 'https://i.ibb.co/W43gCXmh/590427930-17844358662631031-4273442249982202150-n-Photoroom.png';
      ...
      <div class="sp-ticket-app" data-sp-ticket>
        <div class="sp-ticket-card">
          <div class="sp-ticket-front">
            ...
            <img class="sp-ticket-logo" src="${SP_LOGO}" alt="Santo Padre Logo">
          ...
          <div class="sp-ticket-back">
            ...
            <div class="sp-ticket-data">
              ...
              <a class="sp-ticket-qr" href="https://codepen.io/simeydotme" target="_blank">
                <img src="https://assets.codepen.io/13471/simeyqr.svg" alt="QR" style="max-width:100%;display:block;">
              </a>
            </div>
            <aside class="sp-ticket-divider">
              <div class="sp-ticket-username">
                <img class="sp-ticket-profile" src="${SP_LOGO}">
                <span>santopadre.ve</span>
                <img class="sp-ticket-verified" src="https://assets.codepen.io/13471/verified.png">
              </div>
      ...
      <div class="gc-app" data-sp-giftcard data-amount="${amount}">
        <div class="gc-card">
          ...
          <div class="gc-face gc-front">
            ...
            <div class="gc-main">
              <img src="assets/logo.webp" alt="Logo" class="gc-logo-img">
              ...
              <div class="gc-icons-footer">
                <img src="assets/globo-Photoroom.webp" alt="Icon" class="gc-icon-img">
                <img src="assets/C-Photoroom.webp" alt="Icon" class="gc-icon-img">
              </div>
            </div>
          ...
          <div class="gc-face gc-back">
            ...
            <div class="gc-branding-mini"><img src="assets/logo.webp" alt="Logo"></div>
          </div>
        </div>
      </div>
    </div>
